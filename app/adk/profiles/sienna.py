...
SIENNA = CharacterProfile(
    ...
    # Delivery (Option 2): VOICEOVER B-roll — she performs with mouth closed while a single
    # consistent TTS voice narrates, with a music bed + brief-driven captions added in post.
    # This avoids native lip-sync failures and per-clip voice drift across the 5 shots.
