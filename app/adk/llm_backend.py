...
def _resolve_project_and_creds():
    ...
    falls back to the local credentials file for dev.
      ...
      1. GOOGLE_CLOUD_PROJECT for the project id (optional)
      2. GOOGLE_APPLICATION_CREDENTIALS or ./google-credentials.json for the key
         (gitignored; rotate the key that is in git history — current_status.md §8)
    """
